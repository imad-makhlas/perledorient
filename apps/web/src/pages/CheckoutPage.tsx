...
const defaults: CheckoutForm = { firstName: '', lastName: '', telephone: '', email: '', city: 'Casablanca', address: '', postalCode: '', deliveryNotes: '', paymentMethod: 'WHATSAPP', acceptedTerms: true }
...
export function CheckoutPage() {
  ...
  const fields: [keyof CheckoutForm, string, string][] = [['firstName', t('firstName'), 'text'], ['lastName', t('lastName'), 'text'], ['telephone', t('telephone'), 'tel'], ['email', t('email'), 'email'], ['city', t('city'), 'text'], ['postalCode', 'Postal code (optional)', 'text']]
