    ...
    <section className="container-shell grid gap-8 py-9 sm:py-16 lg:grid-cols-[1fr_.9fr] lg:items-center lg:gap-20 lg:py-12">
      ...
      <aside className="relative overflow-hidden rounded-[24px] bg-[#302A2E] p-6 text-ivory shadow-[0_24px_70px_rgba(64,16,31,.16)] sm:rounded-[28px] sm:p-10 lg:p-12">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <a href="https://wa.me/212600000000" target="_blank" rel="noreferrer" className="button-primary button-accent w-full justify-between"><span className="flex items-center gap-3"><MessageCircle size={17} />{copy.whatsapp}</span><ArrowUpRight size={16} /></a>
