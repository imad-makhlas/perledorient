...
export function DeliverySettingsEditor({ settings, busy, onSave }: Props) {
  ...
  return <form onSubmit={submit}>
    ...
    <div className="mt-7 grid gap-5 xl:grid-cols-[1fr_.8fr]">
      <section className="rounded-[6px] border border-[#DDD4C9] bg-white p-5 shadow-[0_14px_40px_rgba(48,42,46,.05)] sm:p-7">
      ...
      <aside className="overflow-hidden rounded-[6px] bg-[#302A2E] text-white shadow-[0_18px_45px_rgba(48,42,46,.12)]">
        ...
        <div className="m-5 rounded-[6px] border border-[#D9AB57]/25 bg-[#D9AB57]/10 p-4 text-sm leading-6 text-white/70 sm:m-7">Livraison offerte au Maroc dès <strong className="text-white">{draft.freeThreshold} MAD</strong>. L’international est confirmé sur WhatsApp.</div>
      </aside>
    </div>
  </form>
}
